defmodule MusicotecaWeb.CoreComponents do
  @moduledoc """
  ...
  def translate_error({msg, opts}) do
    ...
    if count = opts[:count] do
      Gettext.dngettext(MusicotecaWeb.Gettext, "errors", msg, msg, count, opts)
    else
      Gettext.dgettext(MusicotecaWeb.Gettext, "errors", msg, opts)
    end
  end
